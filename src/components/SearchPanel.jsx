...
export const SearchPanel = ({ openSearch, handleOpenSearch }) => {
  ...
  return (
    <>
      {/* <Header /> */}
      <div
        className={`fixed lg:px-0 px-4 overflow-y-auto w-full top-0 h-screen duration-300 origin-top left-0 bg-white z-50 pt-[43px] pb-8 ${
          openSearch ? "block" : "hidden"
        }`}
      >
        <header className="max-w-[1061px] mx-auto pb-[115px]">
          <div className={`flex items-center justify-between`}>
            ...
            >
              ...
              <ul className="flex gap-[30px]">
                <li>
                  <a className="text-[#696F79]" href="#!">
                    Новости
                  </a>
                </li>
                <li>
                  <a className="text-[#696F79]" href="/treatment">
                    Лечение
                  </a>
                </li>
                <li>
                  <a className="text-[#696F79]" href="/clinics">
                    Клиники
                  </a>
                </li>
                <li>
                  <a className="text-[#696F79]" href="/doctors">
                    Врачи
                  </a>
                </li>
                <li>
                  <a className="text-[#696F79]" href="/forums">
                    Форумы
                  </a>
                </li>
                <li>
              ...
              <div className={`w-[1px] line h-[20px] ${"bg-[#696F79]"}`}></div>
              <div className="flex gap-[14px]">
                <button
                  aria-label="Ru language btn"
                  className={`${"text-[#696F79]"} before:bg-teal relative before:content-[''] before:rounded-full before:w-full before:h-[1px] before:absolute before:bottom-0 before:left-0 before:opacity-0 ${
                    activeLanguage === "ru"
            ...
            <div className="items-center gap-[10px] header__right-btn hidden">
              <button
                className="hamburger__menu hidden"
                onClick={handleChangeActive}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button
                className="close__icon lg:hidden block"
