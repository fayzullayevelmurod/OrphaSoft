      ...
      <div className="container">
        <div className="space-y-[43px] max-w-[760px] mx-auto mt-[62px]">
          ...
          <p className="text-[#696F79] leading-[30.6px] text-lg font-light">
            ...
            социально-экономическое развитие способствует подготовке и
            реализации стандартных подходов. Повседневная практика показывает,
            что повышение уровня гражданского сознания требует от нас анализа
          ...
          <p className="text-[#696F79] leading-[30.6px] text-lg font-light">
            ...
            уклада в значительной степени обусловливает важность дальнейших
            направлений развития. Учитывая ключевые сценарии поведения,
            высококачественный прототип будущего экономической целесообразности
